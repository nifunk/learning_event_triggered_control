...
# almost same parametrization of NN policies as in functioning_implementations/own_algorithm_RELU_only
...
class MlpPolicy(object):
    ...
    def _init(self, ob_space, ac_space, hid_size, num_hid_layers, gaussian_fixed_var=True, num_options=2,dc=0):
        ...
        ac_mean = mean
        ac_mean = U.switch(option[0], ac_mean, tf.stop_gradient(ob[:,-self.ac_space_dim:]))
