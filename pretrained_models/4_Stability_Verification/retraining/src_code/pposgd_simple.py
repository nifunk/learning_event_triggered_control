...
def learn(env, policy_func, *,
    ...
    gamename += app
    version_name = '5_NORM-ACT-LOWER-LR-len-400-wNoise-update1-ppo-ESCH-1-1-0-nI' 
    ...
    if wsaves:
        ...
        for i in range(len(files)):
            src = os.path.join('/home/nfunk/Code_MA/ppoc_off_tryout/baselines/baselines/ppo15/') + files[i]
            print (src)
