...
class PendulumEnv(gym.Env):
    ...
    def __init__(self, g=10.0, **kwargs):
        ...
        self.rew_scale = 1.0#0.55   # 1.0 for 0.1 / 0.75 for 1.0 / 0.33 for 10.0
    ...
    def reset(self):
        ...
        if (self.start_top):
            ...
            if (self.use_noise):
                s_init = [0, 0] + np.random.normal(0.0,1e-1,(2, )) # can also use e-1 -> more disturbed
            else:
                #s_init = [0.01, 0.0]
                s_init = [0, 0] + np.random.normal(0.0,1e-1,(2, ))
        else:
