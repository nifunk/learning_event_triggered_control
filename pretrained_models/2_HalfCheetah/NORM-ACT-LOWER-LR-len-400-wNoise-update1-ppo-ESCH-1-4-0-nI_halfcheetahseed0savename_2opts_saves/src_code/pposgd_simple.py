...
def learn(env, policy_func, *,
    ...
    if wsaves:
        ...
        for i in range(len(files)):
            src = os.path.join('/home/nfunk/Code_MA/PPOC_paper_CODE/baselines/baselines/ppo1/') + files[i]
            print (src)
        ...
        src = os.path.join('/home/nfunk/Code_MA/PPOC_paper_CODE/nfunk/envs_nf/pendulum_nf.py')         
        shutil.copy2(src,dest)
    ###
